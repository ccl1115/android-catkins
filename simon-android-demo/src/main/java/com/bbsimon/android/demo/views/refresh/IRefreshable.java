...
public interface IRefreshable {
  ...
  class PagesCoverWrappedListView extends ViewGroup
      implements AbsListView.OnScrollListener, IRefreshable {
    ...
    public PagesCoverWrappedListView(final Context context,
      ...
      final AbsListView.OnScrollListener
          innerScrollListener = new AbsListView.OnScrollListener() {
        @Override
    ...
    public final void onScrollStateChanged(final AbsListView view,
                                           final int scrollState) {
      for (final AbsListView.OnScrollListener listener : mOnScrollListeners) {
    ...
    public final void removeOnScrollListener(final AbsListView.OnScrollListener listener) {
